...
**[Alx Project Setup]** is a project at set up file
...
```sh
  cd my-folder
  git clone https://github.com/Armynerh/
```
...
I would like to thank the contributors and reviewers.
